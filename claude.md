...
## ✅ 완료된 기능
1. **To Solve 칸반 보드** — 3컬럼, 네이티브 HTML5 DnD(데스크톱 전용 트레이드오프), 문제 추가/수정/삭제 모달, 플랫폼 배지 + Codeforces 티어 색상 난이도 칩 + 태그 칩. (Done 전환 시 오답 노트 자동 생성은 2026-07-13 제거 — 변경 사항 #5)
